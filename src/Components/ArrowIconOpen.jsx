    ...
    <svg width="64px" height="64px" viewBox="-2.4 -2.4 28.80 28.80" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g id="SVGRepo_iconCarrier">
            <path
                ...
                stroke="#e4e4d7" stroke-width="2.4"></path>
            <path d="M14.5 11L12 13.5L9.5 11" stroke="#e4e4d7" stroke-width="2.4" stroke-linecap="round"
                  stroke-linejoin="round"></path>
        </g>
    </svg>
);

export default ArrowIconOpen;